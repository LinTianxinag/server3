...
/*******************************************************************************
 *   函数名称: CRC16
 *   功能描述: 查表法计算CRC16. 针对MODBUS规范, 返回值低字节在前, 高字节在后.
 *   输入参数: dataIn -- 待校验数据
 *             length -- 数据长度
 *   返 回 值: 校验值.
 *******************************************************************************/
function CRC16(plain)
{
    var CRCH = 0xFF;
    var CRCL = 0xFF;
    var index;
...
{
    var crc = modBUSCRC16(plain);
    crc = crc.toString(16).toUpperCase();
    return Driver.Padding(crc, 4);
};