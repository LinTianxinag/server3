...
var ErrorCodeList = {
    ...
    'FORMULAERROR':         20000033,   //公式错误
    'PROJECTMODULEERROR':   20000034,   //模块错误
    'PROJECTWARRANTYERROR':   20000035,   //项目有效期错误
    'PROJECTTYPEERROR':   20000036,   //项目类型错误
    ...
    'DEVICEHASNOAPIACCOUNT':         60000014,   //仪表未配置操作账户（海兴设备）
    'CONTROLCODEERROR': 60000015,   //控制码不正确
};
...
var ErrorMessageList = {
    ...
    'PARAMETERERROR': '参数错误',
    'FORMULAERROR': '公式错误',
    'PROJECTMODULEERROR': '待开通模块错误',
    'PROJECTWARRANTYERROR': '项目有效日期错误，取值返回30～36500天',
    'PROJECTTYPEERROR': '项目类型错误',
...
exports.ack = function (code, result) {
    var message = ErrorCode2Message[code];
    var ret = {
        code: code,
        message: message
    };
